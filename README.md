...
│   ├── src/app/               # Pages: dashboard, property, legal, negotiate...
│   ├── src/components/        # Shared UI components
│   └── public/assets/         # Screenshots & static assets
│
└── backend/                   # FastAPI Python server
    ├── api/routes/            # REST endpoints
    ├── services/              # AI agents (Legal, Negotiation, Matching...)
    ├── database/models/       # Beanie MongoDB models
